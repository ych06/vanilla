...
*/
    ...
    * @param array        $Options An array of options for the method. - <b>Sep</b>: The string to seperate index columns by. Default '|'. - <b>Unique</b>: Whether or not the results are unique. - <b>true</b> (default): The index is unique. - <b>false</b>: The index is not unique and each indexed row will be an array or arrays.
