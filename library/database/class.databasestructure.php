 ...
 * @var string The name of the storage engine for this table.
    ...
    * @param string  $KeyType     What type of key is this column on the table? Options are primary, key, and FALSE (not a key). are primary, key, and FALSE (not a key).
 ...
 * Load the schema for this table from the database.
    ...
    * $this->Column().
    * @param boolean $Drop     If TRUE, and the table specified with $this->Table() already exists, this method will drop the table before attempting to re-create it.
