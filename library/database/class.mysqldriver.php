...
class Gdn_MySQLDriver extends Gdn_SQLDriver
{
    ...
    * @param array  $Data   An associative array of FieldName => Value pairs that should be inserted, or an array of FieldName values that should have values inserted from $Select. or an array of FieldName values that should have values inserted from $Select.
