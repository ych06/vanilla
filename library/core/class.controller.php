...
class Gdn_Controller extends Gdn_Pluggable
{
    ...
    * @param mixed  $Asset          The asset to be rendered in the view. This can be one of: - <b>string</b>: The string will be rendered. - </b>Gdn_IModule</b>: Gdn_IModule::Render() will be called. - <b>string</b>: The string will be rendered. - </b>Gdn_IModule</b>: Gdn_IModule::Render() will be called.
    * - <b>string</b>: The string will be rendered.
    * - </b>Gdn_IModule</b>: Gdn_IModule::Render() will be called.
    * @param string $AssetName      The name of the asset being added. This can be used later to sort assets before rendering.
 ...
 * Get a value out of the controller's data array.
    ...
    * false on failure.
    *
    * @param string $View              The name of the view to fetch. If not specified, it will use the value of $this->View. If $this->View is not specified, it will use the value of $this->RequestMethod (which is defined by the dispatcher class).
    ...
    * of $this->View. If $this->View is not specified, it will use the value
    * of $this->RequestMethod (which is defined by the dispatcher class).
    * @param string $ControllerName    The name of the controller that owns the view if it is not $this. - If the controller name is FALSE then the name of the current controller will be used. - If the controller name is an empty string then the view will be looked for in the base views folder.
