...
require PATH_LIBRARY . '/vendors/phpass/PasswordHash.php';
    ...
    */
    function CheckPassword($Password, $StoredHash, $Method = false, $Username = null) 
    {
        ...
        case 'django':
            ...
            break;
        case 'drupal':
            include_once PATH_LIBRARY.'/vendors/drupal/password.inc.php';
        ...
        case 'mybb':
            ...
            break;
        case 'phpbb':
            include_once PATH_LIBRARY.'/vendors/phpbb/phpbbhash.php';
        ...
        case 'yaf':
            ...
            break;
        case 'webwiz':
            include_once PATH_LIBRARY.'/vendors/misc/functions.webwizhash.php';
