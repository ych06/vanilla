...
class Gdn_Locale extends Gdn_Pluggable
{
    ...
    *
    * @param string $LocaleName           The name of the locale to load. Locale definitions are kept in each application's locale folder. For example: /dashboard/locale/$LocaleName.php /vanilla/locale/$LocaleName.php
    * application's locale folder. For example:
    *  /dashboard/locale/$LocaleName.php
    *  /vanilla/locale/$LocaleName.php
    * @param array  $ApplicationWhiteList An array of application folders that are safe to examine for locale definitions.
    *  definitions.
    * @param array  $PluginWhiteList      An array of plugin folders that are safe to examine for locale definitions. definitions.
    *  definitions.
    * @param bool   $ForceRemapping       For speed purposes, the application folders are crawled for locale sources. Once sources are found, they are saved in the cache/locale_mapppings.php file. If ForceRemapping is true, this file will be ignored and the folders will be recrawled and the mapping file will be re-generated. You can also simply delete the file and it will automatically force a remapping. sources. Once sources are found, they are saved in the cache/locale_mapppings.php file. If ForceRemapping is true, this file will be ignored and the folders will be recrawled and the mapping file will be re-generated. You can also simply delete the file and it will automatically force a remapping.
    ...
    *
    * @param mixed  $Code        The code to provide a translation for, or an array of code => translation values to be set. values to be set.
    * values to be set.
    ...
    *
    * @param  string $Code    The code related to the language-specific definition. Codes thst begin with an '@' symbol are treated as literals and not translated.
