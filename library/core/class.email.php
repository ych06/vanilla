...
class Gdn_Email extends Gdn_Pluggable
{
    ...
    * @param  string $RecipientName  The recipient name associated with $RecipientEmail. If $RecipientEmail is an array of email addresses, this value will be ignored.
