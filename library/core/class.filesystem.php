...
class Gdn_FileSystem
{
    ...
    * FALSE if not found.
    *
    * @param mixed  $SourceFolders A string (or array of strings) representing the path to the root of the search.
    * search.
    * @param string $FileName      The name of the file to search for.
    * @param mixed  $WhiteList     An option white-list of sub-folders within $SourceFolders in which the search can be performed. If no white-list is provided, the search will only be performed in $SourceFolder. search can be performed. If no white-list is provided, the search will only be performed in $SourceFolder.
    ...
    * search.
    * @param string $FileName      The name of the file to search for.
    * @param mixed  $WhiteList     An option white-list of sub-folders within $SourceFolder in which the search can be performed. If no white-list is provided, the search will only be performed in $SourceFolder. search can be performed. If no white-list is provided, the search will only be performed in $SourceFolder.
    * search can be performed. If no white-list is provided, the search will
    * only be performed in $SourceFolder.
    */
    ...
    * @param mixed   $SourceFolders A string (or array of strings) representing the path to the root of the search.
    * search.
    * @param mixed   $WhiteList     An optional white-list array of sub-folders within $SourceFolder in which the search can be performed. If FALSE is specified instead, the search will only be performed in $SourceFolders. the search can be performed. If FALSE is specified instead, the search will only be performed in $SourceFolders.
    * the search can be performed. If FALSE is specified instead, the search
    * will only be performed in $SourceFolders.
    * @param string  $FileName      The name of the file to search for.
    * @param boolean $ReturnFirst   Should the method return the path to the first occurrence of $FileName, or should it return an array of every instance in which it is found? Default is to return an array of every instance.
    ...
    * @param mixed  $FolderWhiteList  A white-list array of sub-folders within $SourceFolder in which the search can be performed. If FALSE is specified instead, the search will only be performed in $SourceFolders. search can be performed. If FALSE is specified instead, the search will only be performed in $SourceFolders.
    * search can be performed. If FALSE is specified instead, the search will
    * only be performed in $SourceFolders.
    * @param string $LibraryName      The name of the library to search for. This is a valid file name. ie. "class.database.php"
