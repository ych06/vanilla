...
class Gdn_Model extends Gdn_Pluggable
{
    ...
    * @param  array $Settings       If a custom model needs special settings in order to perform a save, they would be passed in using this variable as an associative array.
    ...
    */
    ...
    {
        $Data = array_diff_key(
            $Data, array('Attributes' => 0, 'DateInserted' => 0, 'InsertUserID' => 0, 'InsertIPAddress' => 0, 'CheckBoxes' => 0,
