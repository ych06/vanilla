...
class Gdn_Format
{
    ...
    * @param  int    $ProfileUserID If looking at a user profile, this is the UserID of the profile we are looking at.
    *  looking at.
    * @return string
    */
    ...
    */
    public static function Links($Mixed) 
    {
        ...
        if (!is_string($Mixed)) {
            ...
            Gdn::PluginManager()->FireAs('Format')->FireEvent(
                'Links', array(
                'Mixed' => &$Mixed
                )
            );
    ...
    public static function Markdown($Mixed) 
    {
        if (!is_string($Mixed)) {
            ...
            if (is_null($Formatter)) {
                ...
                include_once PATH_LIBRARY.'/vendors/markdown/Michelf/MarkdownExtra.inc.php';
