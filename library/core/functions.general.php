 ...
 * Concatenate a string to another string with a seperator.
    ...
    * @param  mixed  $Str2 The second string in the concatenation chain. - This parameter can be an array in which case all of its elements will be concatenated. - If this parameter is a string then the function will look for more arguments to concatenate.
 ...
 * Convert various forms of querystring limit/offset, page, limit/range to database limit/offset
    *
    * @param string $OffsetOrPage    The page query in one of the following formats: - p<x>: Get page x. - <x>-<y>: This is a range viewing records x through y. - <x>lim<n>: This is a limit/offset pair. - <x>: This is a limit where offset is given in the next parameter.
    *  - p<x>: Get page x.
...
if (!function_exists('SaveToConfig')) {
    ...
    *
    * @param  string|array $Name    One of the following: - string: The key to save. - array: An array of key/value pairs to save.
    *  - string: The key to save.
    *  - array: An array of key/value pairs to save.
    * @param  mixed|null   $Value   The value to save.
    * @param  array|bool   $Options An array of additional options for the save. - Save: If this is false then only the in-memory config is set. - RemoveEmpty: If this is true then empty/false values will be removed from the config.
