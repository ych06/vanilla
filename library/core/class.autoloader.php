...
class Gdn_Autoloader
{
    ...
    */
                ...
                foreach (Gdn::PluginManager()->SearchPaths() as $SearchPath => $SearchPathName) {
                    ...
                    if (Gdn::PluginManager()->Started()) {
                        ...
                        foreach ($Folders as $PluginFolder) {
                            ...
                            self::RegisterMap(
                                self::MAP_LIBRARY, self::CONTEXT_PLUGIN, $FullPluginPath, array(
    ...
    public static function AttachApplication($Application) 
    {
        ...
        self::RegisterMap(
            self::MAP_CONTROLLER, self::CONTEXT_APPLICATION, $AppControllers, array(
        ...
        self::RegisterMap(
            self::MAP_LIBRARY, self::CONTEXT_APPLICATION, $AppModels, array(
            'SearchSubfolders'      => false,
            'Extension'             => $Application,
            'ClassFilter'           => '*model'
            )
        ...
        self::RegisterMap(
            self::MAP_LIBRARY, self::CONTEXT_APPLICATION, $AppModules, array(
            'SearchSubfolders'      => false,
            'Extension'             => $Application,
            'ClassFilter'           => '*module'
            )
        ...
        self::RegisterMap(
            self::MAP_LIBRARY, self::CONTEXT_APPLICATION, $AppLibrary, array(
            'SearchSubfolders'      => false,
            'Extension'             => $Application,
            'ClassFilter'           => '*'
            )
