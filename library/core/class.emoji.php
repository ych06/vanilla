...
class Emoji
{
    ...
    */
    protected function checkAliases() 
    {
        $this->aliases = array_filter(
            $this->aliases, function ($emojiName) {
    ...
    * @param array  $manifest  An emoji manifest with the following keys: - emoji: An array in the form: name => filename (ex. ['smile' => 'smile.png']) - aliases (optional): An array of emoji short forms: alias => emojiName  (ex. [':)' => 'smile']) - editor (optional): An array of emoji that will display in the editor: emojiName (ex: [smile,..]) - format (optional): The string format of the emoji replacement. - emoji: An array in the form: name => filename (ex. ['smile' => 'smile.png']) - aliases (optional): An array of emoji short forms: alias => emojiName  (ex. [':)' => 'smile']) - editor (optional): An array of emoji that will display in the editor: emojiName (ex: [smile,..]) - format (optional): The string format of the emoji replacement.
    ...
    */
    public function translateToHtml($Text) 
    {
        ...
        $Text = preg_replace_callback(
            "`({$ldelim}[a-z0-9_+-]+{$rdelim})`i", function ($m) use ($emoji) {
                $emoji_name = trim($m[1], ':');
