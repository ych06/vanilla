...
if (!function_exists('ButtonDropDown')) :
    /**
    *
    * @param array        $Links    An array of arrays with the following keys: - Text: The text of the link. - Url: The url of the link. - Text: The text of the link. - Url: The url of the link.
