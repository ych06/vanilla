...
class Gdn_Dispatcher extends Gdn_Pluggable
{
    ...
    * @param mixed  $Asset     The string asset to be added. The asset can be one of two things. - <b>string</b>: The string will be rendered to the page. - <b>Gdn_IModule</b>: The Gdn_IModule::Render() method will be called when the asset is rendered. - <b>string</b>: The string will be rendered to the page. - <b>Gdn_IModule</b>: The Gdn_IModule::Render() method will be called when the asset is rendered.
