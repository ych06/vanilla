 ...
 * Test a value against an expression.
    ...
    * @param string $Expr  The expression to test against. The expression can have the following properties. - <b>Enclosed in backticks (`..`): A preg_match() is performed. - <b>Otherwise</b>: A simple $Value == $Expr is tested.
