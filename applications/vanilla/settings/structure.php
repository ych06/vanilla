...
if ($FirstCommentIDExists && !$BodyExists) {
    $Construct->Query(
        "update {$Prefix}Discussion, {$Prefix}Comment
...
// Add stub content
require PATH_APPLICATIONS . DS . 'vanilla' . DS . 'settings' . DS . 'stub.php';

// Set current Vanilla.Version
$ApplicationInfo = array();
require CombinePaths(array(PATH_APPLICATIONS . DS . 'vanilla' . DS . 'settings' . DS . 'about.php'));
