...
class SpamModel extends Gdn_Pluggable
{
    ...
    * @param array  $Options    Options for fine-tuning this method call. - Log: Log the record if it is found to be spam. - Log: Log the record if it is found to be spam.
