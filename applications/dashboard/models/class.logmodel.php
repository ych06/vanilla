...
class LogModel extends Gdn_Pluggable
{
    ...
    public function FormatDiff($Old, $New, $Method = 'html') 
    {
        ...
        if ($TinyDiff === null) {
            include_once dirname(__FILE__).'/tiny_diff.php';
    ...
    *
    * @param  string $Operation  The operation being performed. This is usually one of: - Delete: The record has been deleted. - Edit: The record has been edited. - Spam: The record has been marked spam. - Moderate: The record requires moderation. - Pending: The record needs pre-moderation.
    ...
    * @param  array  $Data       The record data. - If you are logging just one row then pass the row as an array. - You can pass an additional _New element to tell the logger what the new data is. - If you are logging just one row then pass the row as an array. - You can pass an additional _New element to tell the logger what the new data is.
