...
class ExportModel
{
     ...
     * @param mixed  $DsnOrPDO One of the following: - <b>String</b>: The dsn to the database. - <b>PDO</b>: An existing connection to the database. - <b>Null</b>: The PDO connection will not be set.
     ...
     * @param mixed  $Query     The query that will fetch the data for the export this can be one of the following: - <b>String</b>: Represents a string of sql to execute. - <b>PDOStatement</b>: Represents an already executed query resultset. - <b>Array</b>: Represents an array of associative arrays or objects containing the data in the export. - <b>String</b>: Represents a string of sql to execute. - <b>PDOStatement</b>: Represents an already executed query resultset. - <b>Array</b>: Represents an array of associative arrays or objects containing the data in the export.
     ...
     *  @param array  $Mappings  Specifies mappings, if any, between the source and the export where the keys represent the export columns and the values represent the source columns. For a list of the export tables and columns see $this->Structure(). For a list of the export tables and columns see $this->Structure().
