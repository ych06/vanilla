...
class ActivityModel extends Gdn_Model
{
    ...
    * @param  string $Type         One of the following: - Popup: Popup a notification. - Email: Email the notification. - NULL: True if either notification is true. - both: Return an array of (Popup, Email).
