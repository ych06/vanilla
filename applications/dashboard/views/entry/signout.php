...
<div id="Leave">
   ...
   <div class="Box">
      <p id="LeavingWrap" class="Leaving" <?php if (!$this->Leaving) { echo 'style="display: none;"'; 
} ?>><?php echo T('SigningOut', 'Hang on a sec while we sign you out.'); ?> <span class="TinyProgress"></span></p>
