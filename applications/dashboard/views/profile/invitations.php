      ...
      <td class="Alt"><?php
        if ($Invitation->AcceptedName == '') {
            ...
            echo Wrap(
                ...
                .' | '.
                Anchor(T('Send Again'), "/profile/sendinvite/{$Invitation->InvitationID}", 'SendAgain Hijack'), 'div'
            );
        } else {
            ...
            echo Wrap(
                Anchor(T('Remove'), "/profile/deleteinvitation/{$Invitation->InvitationID}", 'Delete Hijack'), 'div'
            );
        }
