...
if($CurrentStep < 1) {
    ...
    echo '<div class="Info">',
    T(
        'Garden.Import.Info', 'You\'re almost ready to start the import.
Please review the information below and click <b>Start Import</b> to begin the import.'
   ...
   Click <b>Finished</b> when you are ready.'
        ...
        echo '<div class="Info">',
         T(
             'Garden.Import.Continue.Description', 'It appears as though you are in the middle of an import.
...
require $this->FetchViewLocation('stats', 'import', 'dashboard');
