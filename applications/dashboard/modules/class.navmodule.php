...
class NavModule extends Gdn_Module
{
    ...
    * @param array  $group The group with the following key(s): - **text**: The text of the group. Html is allowed. - **sort**: Specify a custom sort order for the item. This can be either a number or an array in the form ('before|after', 'key').
    ...
    * @param array        $link The link with the following keys: - **url**: The url of the link. - **text**: The text of the link. Html is allowed. - **icon**: The html of the icon. - **badge**: The link contain a badge. such as a count or alert. Html is allowed. - **sort**: Specify a custom sort order for the item. This can be either a number or an array in the form ('before|after', 'key').
