...
#### Build - `npm run build`
Compiles all theme assets using Grunt. LESS stylesheets will be compiled to [`design/custom.css`](design/custom.css) and Javascripts will be concatenated and output to [`js/custom.js`](js/custom.js).
...
---
Copyright &copy; 2014 [Becky Van Bussel](http://vanillaforums.com). Licensed under the terms of the [MIT License](LICENSE.md).
